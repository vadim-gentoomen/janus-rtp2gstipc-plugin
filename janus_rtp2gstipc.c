...
#define RTP2GSTIPC_VERSION_STRING	"0.9.2"
#define RTP2GSTIPC_DESCRIPTION "Forwards RTP and RTCP to an external UDP receiver/decoder"
#define RTP2GSTIPC_NAME "rtp2gstipc"
#define RTP2GSTIPC_AUTHOR	"Michael Karl Franzl"
